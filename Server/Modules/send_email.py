...
def send_email(user_name: str, target_email: str, id_code: str, opt: int = 0) -> bool:
    """发送验证邮件
    ...
    <head>
      <title>请完成Fight Against Gravity账户验证！</title>
      <!--[if !mso]><!-- -->
                                ...
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Muli, Arial, sans-serif;font-size:20px;font-weight:400;line-height:30px;text-align:left;color:#333333;">
                                      <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;">完成Fight Against Gravity账户邮箱验证</h1>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Muli, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#333333;">
                                      ...
                                      <p style="margin: 0;">如果您从未选择验证Fight Against Gravity账户，请忽略此邮件！</p>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
